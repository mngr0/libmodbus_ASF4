...
int coilRead(modbus_mapping_t *mb_mapping, int address);
int discreteInputRead(modbus_mapping_t *mb_mapping,int address);
long holdingRegisterRead(modbus_mapping_t *mb_mapping,int address);
long inputRegisterRead(modbus_mapping_t *mb_mapping,int address);
int coilWrite(modbus_mapping_t *mb_mapping,int address, uint8_t value);
int holdingRegisterWrite(modbus_mapping_t *mb_mapping,int address, uint16_t value);
int registerMaskWrite(modbus_mapping_t *mb_mapping,int address, uint16_t andMask, uint16_t orMask);
